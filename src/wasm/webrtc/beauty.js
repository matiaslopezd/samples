...
if (!ENVIRONMENT_IS_PTHREAD) ENVIRONMENT_IS_PTHREAD = false;
...
STATICTOP = STATIC_BASE + 316816;
if (!ENVIRONMENT_IS_PTHREAD) __ATINIT__.push({
    func: (function() {
        __GLOBAL__sub_I_embind_cc()
    })
}, {
    func: (function() {
                ...
                worker.onmessage = (function(e) {
                    ...
                    if (d.proxiedCall) {
                        ...
                        switch (d.proxiedCall & 31) {
                            case 1:
                                returnValue = funcTable[funcIdx]();
                                break;
                            case 2:
                                returnValue = funcTable[funcIdx](d.p0);
                                break;
                            case 3:
                                returnValue = funcTable[funcIdx](d.p0, d.p1);
                                break;
                            case 4:
                                returnValue = funcTable[funcIdx](d.p0, d.p1, d.p2);
                                break;
                            case 5:
                                returnValue = funcTable[funcIdx](d.p0, d.p1, d.p2, d.p3);
                                break;
                            case 6:
                                returnValue = funcTable[funcIdx](d.p0, d.p1, d.p2, d.p3, d.p4);
                                break;
                            case 7:
                                returnValue = funcTable[funcIdx](d.p0, d.p1, d.p2, d.p3, d.p4, d.p5);
                                break;
                            case 8:
                                returnValue = funcTable[funcIdx](d.p0, d.p1, d.p2, d.p3, d.p4, d.p5, d.p6);
                                break;
                            case 9:
                                returnValue = funcTable[funcIdx](d.p0, d.p1, d.p2, d.p3, d.p4, d.p5, d.p6, d.p7);
                                break;
                            case 10:
                                returnValue = funcTable[funcIdx](d.p0, d.p1, d.p2, d.p3, d.p4, d.p5, d.p6, d.p7, d.p8);
                                break;
                            default:
                                if (d.proxiedCall) {
                    ...
                    } else if (d.cmd === "exit") {} else if (d.cmd === "cancelDone") {
...
var _stdin;
if (ENVIRONMENT_IS_PTHREAD) _stdin = PthreadWorkerInit._stdin;
else PthreadWorkerInit._stdin = _stdin = allocate(1, "i32*", ALLOC_STATIC);
var _stdout;
if (ENVIRONMENT_IS_PTHREAD) _stdout = PthreadWorkerInit._stdout;
else PthreadWorkerInit._stdout = _stdout = allocate(1, "i32*", ALLOC_STATIC);
var _stderr;
if (ENVIRONMENT_IS_PTHREAD) _stderr = PthreadWorkerInit._stderr;
else PthreadWorkerInit._stderr = _stderr = allocate(1, "i32*", ALLOC_STATIC);
var FS = {
    root: null,
    mounts: [],
    devices: {},
...
function ___syscall102(which, varargs) {
    if (ENVIRONMENT_IS_PTHREAD) {
        return _emscripten_sync_run_in_main_thread_2(138, 102, varargs)
    }
...
function ___syscall140(which, varargs) {
    if (ENVIRONMENT_IS_PTHREAD) {
        return _emscripten_sync_run_in_main_thread_2(138, 140, varargs)
    }
    SYSCALLS.varargs = varargs;
    try {
...
function ___syscall142(which, varargs) {
    if (ENVIRONMENT_IS_PTHREAD) {
        return _emscripten_sync_run_in_main_thread_2(138, 142, varargs)
    }
    SYSCALLS.varargs = varargs;
    try {
...
function ___syscall146(which, varargs) {
    if (ENVIRONMENT_IS_PTHREAD) {
        return _emscripten_sync_run_in_main_thread_2(138, 146, varargs)
    }
    SYSCALLS.varargs = varargs;
    try {
        var stream = SYSCALLS.getStreamFromFD(),
...
function ___syscall221(which, varargs) {
    if (ENVIRONMENT_IS_PTHREAD) {
        return _emscripten_sync_run_in_main_thread_2(138, 221, varargs)
    }
    SYSCALLS.varargs = varargs;
    try {
        var stream = SYSCALLS.getStreamFromFD(),
...
function ___syscall3(which, varargs) {
    if (ENVIRONMENT_IS_PTHREAD) {
        return _emscripten_sync_run_in_main_thread_2(138, 3, varargs)
    }
    SYSCALLS.varargs = varargs;
    try {
        var stream = SYSCALLS.getStreamFromFD(),
...
function ___syscall4(which, varargs) {
    if (ENVIRONMENT_IS_PTHREAD) {
        return _emscripten_sync_run_in_main_thread_2(138, 4, varargs)
    }
    SYSCALLS.varargs = varargs;
    try {
        var stream = SYSCALLS.getStreamFromFD(),
...
function ___syscall42(which, varargs) {
    if (ENVIRONMENT_IS_PTHREAD) {
        return _emscripten_sync_run_in_main_thread_2(138, 42, varargs)
    }
    SYSCALLS.varargs = varargs;
    try {
...
function ___syscall5(which, varargs) {
    if (ENVIRONMENT_IS_PTHREAD) {
        return _emscripten_sync_run_in_main_thread_2(138, 5, varargs)
    }
    SYSCALLS.varargs = varargs;
    try {
...
function ___syscall54(which, varargs) {
    if (ENVIRONMENT_IS_PTHREAD) {
        return _emscripten_sync_run_in_main_thread_2(138, 54, varargs)
    }
    SYSCALLS.varargs = varargs;
    try {
        var stream = SYSCALLS.getStreamFromFD(),
...
function ___syscall6(which, varargs) {
    if (ENVIRONMENT_IS_PTHREAD) {
        return _emscripten_sync_run_in_main_thread_2(138, 6, varargs)
    }
    SYSCALLS.varargs = varargs;
    try {
        var stream = SYSCALLS.getStreamFromFD();
...
else PthreadWorkerInit.__main_thread_futex_wait_address = __main_thread_futex_wait_address = allocate(1, "i32*", ALLOC_STATIC);
...
function _emscripten_futex_wake_or_requeue(addr, count, addr2, cmpValue) {
    if (addr <= 0 || addr2 <= 0 || addr >= HEAP8.length || addr2 >= HEAP8.length || count < 0 || addr & 3 != 0 || addr2 & 3 != 0) {
        return -22
    }
    var mainThreadWaitAddress = Atomics.load(HEAP32, __main_thread_futex_wait_address >> 2);
    var mainThreadWoken = 0;
...
function _sysconf(name) {
    if (ENVIRONMENT_IS_PTHREAD) return _emscripten_sync_run_in_browser_thread_ii(2, name);
    switch (name) {
        case 30:
            return PAGE_SIZE;
        case 85:
...
var proxiedFunctionTable = [null, _getaddrinfo, _sysconf];
...
Module["wasmTableSize"] = 5204;
Module["wasmMaxTableSize"] = 5204;
...
Module.asmLibraryArg = {
    ...
    "___unlock": ___unlock,
    "__embind_create_inheriting_constructor": __embind_create_inheriting_constructor,
    ...
    "_emscripten_futex_wake_or_requeue": _emscripten_futex_wake_or_requeue,
...
var dynCall_iiiijjij = Module["dynCall_iiiijjij"] = (function() {
    return Module["asm"]["dynCall_iiiijjij"].apply(null, arguments)
});
